import { Component, OnInit, Output, EventEmitter, TemplateRef, ViewChild, inject, Signal, signal } from '@angular/core';
...
export class RightsidebarComponent implements OnInit {
  ...
  constructor(private eventService: EventService, private offcanvasService: NgbOffcanvas, private store: Store<RootReducerState>, public router: Router) {
